/**
 * Implement the function to transform a string into its corresponding long
 * value. It can also take the sign characters and long type 'L' indicator as
 * input Throws an exception when encountering the number overflow.
 * 
 * @author Xuezi Zhang
 *
 */
